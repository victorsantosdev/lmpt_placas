	...
	?debug	S "C:\temp\paghi\builder\exemplos\lcd\paralela.cpp"
	?debug	T "C:\temp\paghi\builder\exemplos\lcd\paralela.cpp"
...
$$BNAMES	segment byte public use32 'DEBNAM'
	...
	db	8,'Endereco'
$$BNAMES	ends
	?debug	D "C:\temp\paghi\builder\exemplos\lcd\PARALELA.H" 10906 27239
	?debug	D "C:\temp\paghi\builder\exemplos\lcd\paralela.cpp" 10963 32107
	end
